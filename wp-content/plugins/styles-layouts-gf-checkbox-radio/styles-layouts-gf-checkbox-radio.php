...
class Sk_Stla_Checkbox_Radio { 
	...
	function gform_field_content( $content, $field, $value, $lead_id, $form_id ) {
		...
		$checkbox_fields = array( 'checkbox', 'post_tags', 'post_custom_field', 'post_category', 'quantity', 'option', 'product' );
		$radio_fields = array( 'radio', 'post_tags', 'post_custom_field', 'post_category', 'option', 'shipping', 'product' );
